...
def generate(prompt, uncond_prompt, input_image=None, strength=0.8,
    ...
    with torch.no_grad():
        ...
        if sampler_name == "ddpm" or sampler_name == "ddim":
        ...
        for i, timestep in enumerate(timesteps):
            ...
            if sampler_name == "ddpm":
                ...
                latents = sampler.ddim_step(timestep, latents, model_output)
